...
namespace Lab_09
{
    public partial class FrmSinhVien : Form
    {
        ...
        private void LoadComboBoxKhoa()
        {
            ...
            cbbMaKhoa.DataSource = db.Khoas.ToList();
        ...
        private void dgvSinhVien_SelectionChanged(object sender, EventArgs e)
        {
            ...
            cbbGioiTinh.SelectedItem = row.Cells["GioiTinh"].Value?.ToString() == "Nam" ? "Nam" : "Nữ";

            string? tenKhoa = row.Cells["TenKhoa"].Value?.ToString().Trim();
            foreach (Khoa k in cbbMaKhoa.Items)
                if (k.TenKhoa.Trim() == tenKhoa) { cbbMaKhoa.SelectedItem = k; break; }
        }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sv.GioiTinh = cbbGioiTinh.SelectedItem.ToString() == "Nam";
            sv.DiaChi = txtDiaChi.Text.Trim();
            sv.DienThoai = txtDienThoai.Text.Trim();
            sv.MaKhoa = cbbMaKhoa.SelectedValue?.ToString();
        ...
        private void LamMoiForm()
        {
            ...
            cbbGioiTinh.SelectedIndex = 0;
            if (cbbMaKhoa.Items.Count > 0) cbbMaKhoa.SelectedIndex = 0;
            txtHoTen.Focus();
        }
